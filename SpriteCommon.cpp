...
void SpriteCommon::RootSignatureInitialize()
{
	...
	ZeroMemory(&inputElementDescs[0], sizeof(D3D12_INPUT_ELEMENT_DESC));
	ZeroMemory(&inputElementDescs[1], sizeof(D3D12_INPUT_ELEMENT_DESC));
	ZeroMemory(&inputElementDescs[2], sizeof(D3D12_INPUT_ELEMENT_DESC));
	...
	inputElementDescs[1].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;  // 自動オフセット

	inputElementDescs[2].SemanticName = "NORMAL";
	inputElementDescs[2].SemanticIndex = 0;
	inputElementDescs[2].Format = DXGI_FORMAT_R32G32B32_FLOAT;
	inputElementDescs[2].InputSlot = 0;
	inputElementDescs[2].AlignedByteOffset = D3D12_APPEND_ALIGNED_ELEMENT;  // 自動オフセット
