...
namespace MyEngine {
		...
		const DirectX::ScratchImage& mipImages)
	{
		...
		Microsoft::WRL::ComPtr<ID3D12Resource> intermediateResource = ResourceManager::CreateBufferResource(device_.Get(), intermediateSize);
	...
	{
		dissolveParamBuffer_ = ResourceManager::CreateBufferResource(device_.Get(), sizeof(DissolveParams));
